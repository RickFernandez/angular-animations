...
export class TarefaService {
  ...
  listar(): void {
    ...
    this.http.get<Tarefa[]>(this.API, { params }).subscribe(tarefas => {
      let tarefasTesmporarias = this.tarefasSubject.getValue();
      tarefasTesmporarias = tarefasTesmporarias.concat(tarefas);
      this.tarefasSubject.next(tarefasTesmporarias);
    });
  }
