...
import { checkButtonTrigger, filterTrigger, flyInOutTrigger, formButtonTrigger, highlightedStateTrigger, listSateTrigger, shakeTrigger, shownStateTrigger } from '../animations/animations';
...
export class ListaTarefasComponent implements OnInit {
  ...
  finalizarTarefa(tarefa: Tarefa) {
    ...
    tarefa.statusFinalizado ? this.estadoBotao = 'checked' : this.estadoBotao = 'unchecked';
  }
